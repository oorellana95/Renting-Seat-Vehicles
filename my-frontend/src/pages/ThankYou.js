          ...
          <Container className="ThankYou">
            <Row>
              ...
              <Col xs={12}>
                ...
                {props.booking.object.id && <p>Your book is on the way! Look at your email to see all details and soon you will enjoy your {props.booking.object.vehicle.name} on the road. </p>}
              </Col>
